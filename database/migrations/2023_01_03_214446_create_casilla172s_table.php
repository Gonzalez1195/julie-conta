...
class CreateCasilla172sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('casilla172s', function (Blueprint $table) {
            $table->id();
            $table->string('nit_sujeto', 14)->nullable();
            $table->date('fecha_emision')->nullable();
            $table->string('tipo_documento')->nullable();
            $table->string('serie_documento', 100)->nullable();
            $table->string('numero_resolucion', 23)->nullable();
            ...
            $table->char('numero_anexo')->default('12');
    ...
    {
        Schema::dropIfExists('casilla172s');
    }
}
