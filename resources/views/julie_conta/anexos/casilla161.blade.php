            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Anticipo a cuenta de IVA del 2% efectuada al declarante</h4>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Editar anexo casilla 161</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <form class="form-casilla161-edit" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="nit_agente_efectuo_anticipo_cuenta">NIT del agente que le efectuó el anticipo a cuenta <span class="text-danger">*</span></label>
                                                <div>
