            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Retención 1% IVA a terceros domiciliados efectuadas por el declarante</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Anexos</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Casilla 170</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Editar anexo casilla 170</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form form-validation">
                                @foreach ($retenciones as $retencion)
                                    <form class="form-casilla170-edit" method="POST">
                                        @csrf
                                        <input type="hidden" name="id_casilla170" id="id_casilla170" value="{{ $retencion->id }}">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="nit_sujeto">NIT sujeto <span class="text-danger">*</span></label>
                                                <div>
                                                    <input type="text" name="nit_sujeto" class="form-control" value="{{ $retencion->nit_sujeto }}">
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" name="tipo_documento">
                                                    ...
                                                    <option value="05 Nota de crédito" {{ ($retencion->tipo_documento) == "05 Nota de crédito" ? "selected" : "" }}>05. Nota de crédito</option>
                                                    <option value="06 Nota de débito" {{ ($retencion->tipo_documento) == "06 Nota de débito" ? "selected" : "" }}>06. Nota de débito</option>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div>
                                                    <input type="text" name="numero_resolucion" class="form-control" value="{{ $retencion->numero_resolucion }}">
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div>
                                                    <input type="text" name="" class="form-control monto_retencion" value="{{ $retencion->monto_percepcion }}" disabled>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div>
                                                    <input type="text" name="dui_sujeto" class="form-control" value="{{ $retencion->dui_sujeto }}">
                                                </div>
                                            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Crear anexo casilla 170</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form form-validation">
                                <form class="form-casilla170" method="POST">
                                    @csrf
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="nit_sujeto">NIT sujeto <span class="text-danger">*</span></label>
