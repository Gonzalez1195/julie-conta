            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Retención 13% IVA a terceros domiciliados efectuadas por el declarante </h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Anexos</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Casilla 172</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Editar anexo casilla 172</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form form-validation">
                                @foreach ($retenciones as $retencion)
                                    <form class="form-casilla172-edit" method="POST">
                                        @csrf
                                        <input type="hidden" name="id_casilla172" id="id_casilla172" value="{{ $retencion->id }}">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="monto_retencion">Monto de la retención<span class="text-danger">*</span></label>
                                                <div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Crear anexo casilla 172</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form form-validation">
                                <form class="form-casilla172" method="POST">
                                    @csrf
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="nit_sujeto">NIT sujeto <span class="text-danger">*</span></label>
